...
class SimpleConvHeadAT(nn.Module):
    def __init__(
        self,
        num_classes,
        input_channel,
        ...
        **kwargs
        ...
        super(SimpleConvHeadAT, self).__init__()
    ...
    def forward(self, feats):
        outputs = []
        for x, scale, refine_box in zip(feats, self.scales, self.refine_boxes):
            cls_feat = x
            reg_feat = x
            ...
            bbox_pred_init = scale(self.gfl_reg(reg_feat)).float()
