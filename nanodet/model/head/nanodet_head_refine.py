...
class NanoDetHeadRF(NanoDetPlusHead):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(NanoDetHeadRF, self).__init__(
            num_classes,
            loss,
            input_channel,
            feat_channels,
    ...
    def _get_loss_from_assign(self, cls_preds, reg_preds, decoded_bboxes, decoded_bboxes_refine, assign, epoch):
        ...
        if len(pos_inds) > 0:
            ...
            # th = (0.01 * epoch * epoch + 10*10) if epoch < 100 else 1000000
        ...
        loss = loss_qfl + loss_bbox + loss_dfl + loss_bbox_refine
        loss_states = dict(loss_qfl=loss_qfl, loss_bbox=loss_bbox, loss_dfl=loss_dfl, loss_bbox_refine=loss_bbox_refine)
        return loss, loss_states
